...
export default function SiteHomePage() {
    ...
    return (
        <div className="min-h-screen bg-[#FDFCFB] dark:bg-dark-950 flex flex-col font-sans">
            ...
            <section className="relative min-h-[85vh] flex items-center bg-white dark:bg-dark-900 overflow-hidden isolate shadow-2xl">
                ...
                <div className="w-full max-w-6xl mx-auto px-6 lg:px-10 flex flex-col items-center justify-center text-center relative z-20 xl:scale-[0.85] origin-top transition-transform duration-700">
                    <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-primary-900/5 border border-primary-900/10 mb-8 animate-fade-in">
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-[6rem] font-serif font-black text-primary-950 dark:text-white leading-[0.95] tracking-tighter max-w-5xl text-balance cinzel-title uppercase">
                        S&apos;épanouir par <br className="hidden md:block" />
                    ...
                    <p className="mt-12 text-xl md:text-2xl text-slate-500 dark:text-dark-400 max-w-3xl font-medium leading-relaxed text-balance">
                        Bienvenue au <span className="text-primary-950 dark:text-white font-bold">Centre Culturel Islamique de Québec</span>, votre institution de référence pour l&apos;apprentissage et la vie communautaire.
                    </p>

                    <div className="mt-16 flex flex-col sm:flex-row gap-6 justify-center w-full max-w-xl mx-auto sm:max-w-none px-6">
                        <Link href="/site/education" className="inline-flex items-center justify-center rounded-[2rem] bg-primary-900 px-12 py-6 text-sm font-black text-white shadow-2xl shadow-primary-900/30 hover:bg-black hover:-translate-y-2 transition-all duration-500 uppercase tracking-widest border border-white/10 group">
                            Découvrir l&apos;École Salam
                            <FiArrowRight className="ml-3 text-xl group-hover:translate-x-2 transition-transform" />
                        </Link>
                        <Link href="/site/donate" className="inline-flex items-center justify-center rounded-[2rem] bg-white dark:bg-dark-800 px-12 py-6 text-sm font-black text-primary-900 dark:text-white border border-slate-100 dark:border-dark-700 shadow-xl hover:bg-slate-50 dark:hover:bg-primary-900/40 hover:-translate-y-2 transition-all duration-500 uppercase tracking-widest group">
            ...
            <section id="horaires" className="bg-[#0A100D] text-white relative isolate py-16 lg:py-20 flex items-center min-h-[700px] overflow-hidden pb-48 md:pb-40">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-20 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center relative z-10 w-full xl:scale-[0.9] origin-center transition-transform duration-700">
                    <div className="lg:col-span-12 text-center mb-6">
                        ...
                        <h2 className="text-4xl md:text-6xl font-serif font-black leading-none cinzel-title uppercase group inline-block">
                            ...
                            <div className="space-y-3">
                                {prayerTimes.length > 0 ? (
                                    ...
                                    <div className="py-20 text-center animate-pulse flex flex-col items-center gap-4">
                                        ...
                                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Pr├⌐cision temporelle en cours...</p>
                                    </div>
                                )}
                            </div>
                    ...
                    <div className="lg:col-span-7 space-y-6">
                        <div className="space-y-6">
                            <span className="text-accent-gold font-black uppercase tracking-[0.5em] text-[10px]">Notre Mission</span>
                            <h2 className="text-5xl lg:text-7xl font-serif font-black leading-[0.9] cinzel-title uppercase tracking-tighter">
                                Unir, Servir et <span className="text-accent-gold italic">Éduquer</span>,<br />
                                avec <span className="underline decoration-accent-gold/40 underline-offset-[12px]">Dignité.</span>
                            </h2>
                            <p className="text-xl text-white/60 font-medium leading-relaxed max-w-2xl">
                                Le CCIQ agit proactivement pour le développement spirituel, social et économique de la communauté musulmane tout en favorisant son intégration positive au Québec.
                            </p>
                        </div>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 border-t border-white/5">
                            {[
                                { title: 'Intégration', desc: 'Favoriser une contribution harmonieuse et citoyenne à la société québécoise.', icon: 'handshake' },
                                { title: 'Solidarité', desc: 'Un large éventail de services sociaux et d\'entraide pour tous les membres.', icon: 'diversity_3' }
                            ].map((val, i) => (
            ...
            <section className="py-20 lg:py-24 bg-[#FDFCFB] rounded-t-[5rem] -mt-12 md:-mt-20 relative z-30 shadow-2xl border-t border-slate-100">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-12 xl:scale-[0.9] origin-left transition-transform duration-700">
                        <div className="space-y-4">
                            <span className="text-accent-gold font-black uppercase tracking-[0.5em] text-[10px]">Vie Sociale</span>
                            <h2 className="text-primary-950 font-serif text-5xl lg:text-[5rem] font-black uppercase leading-[0.85] tracking-tighter cinzel-title italic">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-14 xl:scale-[0.9] origin-top transition-transform duration-700">
                            {publicContent
