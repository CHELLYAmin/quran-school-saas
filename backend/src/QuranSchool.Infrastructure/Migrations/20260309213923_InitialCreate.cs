        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartSurah = table.Column<int>(nullable: true),
                    EndSurah = table.Column<int>(nullable: true),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevelationType = table.Column<string>(nullable: false),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrayersJson = table.Column<string>(nullable: false),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedProfileType = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredVolunteers = table.Column<int>(nullable: false),
                    CurrentVolunteers = table.Column<int>(nullable: false),
                    IsPublished = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextArabic = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WordText = table.Column<string>(nullable: false),
                    NormalizedText = table.Column<string>(nullable: false),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(nullable: false),
                    SessionObjective = table.Column<string>(nullable: true),
                    SurahId = table.Column<Guid>(type: "uuid", nullable: true),
                    StartVerse = table.Column<int>(nullable: true),
                    EndVerse = table.Column<int>(nullable: true),
                    IsOnline = table.Column<bool>(type: "boolean", nullable: false),
                    MeetingUrl = table.Column<string>(nullable: true),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLevel = table.Column<string>(nullable: true),
                    TotalXP = table.Column<int>(nullable: false),
                    CurrentStreak = table.Column<int>(nullable: false),
                    LongestStreak = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SurahId = table.Column<Guid>(type: "uuid", nullable: true),
                    ExamLevel = table.Column<string>(nullable: true),
                    StartVerse = table.Column<int>(nullable: true),
                    EndVerse = table.Column<int>(nullable: true),
                    GlobalComment = table.Column<string>(nullable: true),
                    FinalScore = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    FinalStatus = table.Column<string>(nullable: false),
                    IsLevelProgressionExam = table.Column<bool>(type: "boolean", nullable: false),
                    TargetLevel = table.Column<string>(nullable: true),
                    GroupId = table.Column<Guid>(type: "uuid", nullable: true),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    Status = table.Column<string>(nullable: false),
                    StudentNotes = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountReason = table.Column<string>(nullable: true),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    SurahName = table.Column<string>(nullable: true),
                    SurahNumber = table.Column<int>(nullable: true),
                    JuzNumber = table.Column<int>(nullable: true),
                    HizbNumber = table.Column<int>(nullable: true),
                    StartVerse = table.Column<int>(nullable: true),
                    EndVerse = table.Column<int>(nullable: true),
                    Status = table.Column<string>(nullable: false),
                    TeacherNotes = table.Column<string>(nullable: true),
                    RecordDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    QualityScore = table.Column<int>(nullable: true),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    SurahId = table.Column<Guid>(type: "uuid", nullable: false),
                    StartVerse = table.Column<int>(nullable: false),
                    EndVerse = table.Column<int>(nullable: false),
                    RecitationOrder = table.Column<int>(nullable: false),
                    QualityScore = table.Column<int>(nullable: true),
                    GlobalComment = table.Column<string>(nullable: true),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomDescription = table.Column<string>(nullable: true),
                    DueDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionId = table.Column<Guid>(type: "uuid", nullable: false),
                    SurahId = table.Column<Guid>(type: "uuid", nullable: false),
                    VersesCovered = table.Column<string>(nullable: true),
                    BlockedCount = table.Column<int>(nullable: false),
                    ForgottenCount = table.Column<int>(nullable: false),
                    TajwidErrorsCount = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnotationType = table.Column<string>(nullable: false),
                    Comment = table.Column<string>(nullable: true),
                    SchoolId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
